...
import {Input, Row, Card, List, Button, Badge} from 'antd';
        ...
        <div className="content">
                <Row className="header-content">กำลังพิจารณา</Row>
                    <List
                        ...
                        >
                            {item.status === 'success'? null : <div className="badge"></div>}
                           ...
                           <div className="button-card"><Button className={item.status === 'success'? 'button-card wait' : 'button-card success'} disabled={item.status === 'success'? true : false}>{item.status === 'success'? 'กำลังพิจารณา' : 'ต้องการการติดต่อ'}</Button></div>
                        </Card>
                        {/* </Badge> */}
                        </List.Item>
                        )}
